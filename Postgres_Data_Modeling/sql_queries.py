...
songplay_table_create = (""" CREATE TABLE IF NOT EXISTS songplays (songplay_id text, start_time time, user_id text, level text, song_id text, artist_id text, session_id text,
...
song_table_create = (""" CREATE TABLE IF NOT EXISTS songs (song_id text, title varchar, artist_id text, year int, duration numeric);
""")
